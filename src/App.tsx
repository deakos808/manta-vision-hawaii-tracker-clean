...
function App() {
  ...
  return (
    <Routes>
      ...
      {/* Developer Tools (unprotected unless you prefer otherwise) */}
      ...
      {/* NEW: User submission routes (non-admin, map-free option) */}
      <Route
        path="/sightings/add"
        element={
          <RequireAuth>
      ...
      <Route
        path="/admin/import"
        element={<RequireAuth adminOnly><ImportPage /></RequireAuth>}
      />
      <Route
        path="/admin/data-integrity"
        element={<RequireAuth adminOnly><DataIntegrityPage /></RequireAuth>}
      />
      <Route
        path="/admin/best-images"
        element={<RequireAuth adminOnly><BestMantaImageDiagnostics /></RequireAuth>}
      />
      <Route
      ...
      <Route
        ...
        element={<RequireAuth adminOnly><BestCatalogImageDiagnostics /></RequireAuth>}
      />
      <Route
        path="/admin/matching"
        element={<RequireAuth adminOnly><MatchingPage /></RequireAuth>}
      />
      <Route
        path="/admin/diagnostics"
        element={<RequireAuth adminOnly><DiagnosticsPage /></RequireAuth>}
      />
      <Route
        path="/admin/roles"
      ...
      <Route
        ...
        element={<RequireAuth adminOnly><UsersInvitePage /></RequireAuth>}
      />
      <Route
      ...
      <Route
        ...
        element={<RequireAuth adminOnly><MatchDiagnosticsPage /></RequireAuth>}
      />
      <Route
        path="/admin/manta-diagnostics"
        element={<RequireAuth adminOnly><MantaDiagnosticsPage /></RequireAuth>}
      />
      <Route
        path="/admin/manta-match-diagnostics"
        element={<RequireAuth adminOnly><MantaMatchDiagnosticsPage /></RequireAuth>}
      />
      <Route
        path="/admin/manta-photo-diagnostics"
        element={<RequireAuth adminOnly><MantaPhotoDiagnosticsPage /></RequireAuth>}
      />
      <Route
        path="/admin/missing-catalog-photos"
        element={<RequireAuth adminOnly><MissingCatalogPhotosPage /></RequireAuth>}
      />
      <Route
        path="/admin/missing-sighting-photos"
        element={<RequireAuth adminOnly><MissingSightingPhotosPage /></RequireAuth>}
      />
      ...
      <Route
        ...
        element={<RequireAuth adminOnly><ChooseBestMantaPhotoPage /></RequireAuth>}
      />
      <Route
        path="/admin/review"
        element={<RequireAuth adminOnly><AdminReviewNewSightingsPage /></RequireAuth>}
      />
      <Route
        path="/admin/review/sighting/:id"
        element={<RequireAuth adminOnly><ReviewSightingDetailsPage /></RequireAuth>}
      />

      {/* CSV / Diagnostics */}
      <Route
        path="/admin/diagnostics-csv"
        element={<RequireAuth adminOnly><CsvDataReviewPage /></RequireAuth>}
      />
      <Route
        path="/admin/csv-debug"
        element={<RequireAuth adminOnly><CsvDebugPage /></RequireAuth>}
      />

      {/* NEW: Finding Duplicates (both hyphen and underscore aliases) */}
      <Route
        path="/admin/finding-duplicates"
        element={<RequireAuth adminOnly><FindingDuplicatesPage /></RequireAuth>}
      />
      <Route
